...
"background-color: rgb(171, 171, 171);"));
        ...
        logo1->setGeometry(QRect(30, 490, 101, 161));
        ...
        logo2->setGeometry(QRect(310, 560, 181, 51));
...
"background-color: rgb(255, 255, 255);"));
        ...
        font4.setBold(true);
        yellow_gripper->setFont(font4);
        yellow_gripper->setStyleSheet(QString::fromUtf8("color: rgb(50, 50, 50);\n"
"background-color: rgb(171, 171, 171);"));
        ...
        imageValue_screen->setFont(font2);
